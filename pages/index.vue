        ...
        <div v-if="resourceList.length">
          <ul class="space-y-5">
            <li v-for="(resource, index) in resourceList" :key="index">
              <div class="p-4 block bg-white border border-[#D6D7D9] rounded-md shadow">
                <div class="flex items-start gap-x-4">
                  <span class="w-20 h-20 p-2 block shrink-0 text-zinc-500 border border-zinc-200 rounded">
                    <svg class="w-full h-full object-contain object-center" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.47 122.88">
                      <path
                  ...
                  <div class="grow pt-1 space-y-1">
                    ...
                    <NuxtLink :to="'/doctor/' + resource.id + '/type/'"
                      class="px-3 py-1.5 inline-block bg-white hover:bg-zinc-100 text-sm font-bold border border-zinc-200 rounded">Book Now</NuxtLink>
                  </div>
                </div>
